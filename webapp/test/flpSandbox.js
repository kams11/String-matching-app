		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comexamplestringmatchingappdemo-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comexamplestringmatchingappdemo-display": {
								"semanticObject": "comexamplestringmatchingappdemo",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.example.stringmatchingappdemo",
									"url": sap.ui.require.toUrl("com/example/stringmatchingappdemo")
								}
							}
						}
					}
